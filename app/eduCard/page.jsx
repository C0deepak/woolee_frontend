...
import wool2 from '../images/thread.jpeg'
    ...
    <div className='flex flex-col border-gray-400 border-2 w-2/4 '>
        <div className='flex justify-between mt-2'>
            <div className='flex ml-3'>
                ...
                <Image src={wool2}  alt="....."width={40} height={40} className='border-black border-2 rounded-full'/>
                </div>
        ...
        <div className='flex m-3 text-justify'>
            ...
            <div  className='w-5/8'>
            <Image src={wool2}  alt="....."width={600} height={600} className='rounded-xl ml-2'/>
            </div>
        </div>
